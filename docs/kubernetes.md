...
helm install ci oci://ghcr.io/bigg01/charts/claude-ci-agent --version 0.1.0-alpha.5

# …or from the .tgz attached to the release
helm install ci https://github.com/bigg01/claude-ci-agent/releases/download/v0.1.0-alpha.5/claude-ci-agent-0.1.0-alpha.5.tgz
```
